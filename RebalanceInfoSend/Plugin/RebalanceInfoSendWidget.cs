...
namespace RebalanceInfoSend.Client.Plugin
{
    ...
    using RebalanceInfoSend.Client.Model;
    ...
    public class RebalanceInfoSendWidget : WidgetSubscriber, IWidget
    {
        private readonly IReactivePublisher publisher;
        private RebalanceInfoVisual GenericWindow;
        private RebalanceInfoSendParams pluginParameters;
        private const string AccountIdColumnName = "account_id";

        [ImportingConstructor]
        public RebalanceInfoSendWidget(IReactivePublisher publisher
           , RebalanceInfoSendViewerModel genericGridViewerMode)
            : base(publisher)
        {
            ...
            this.Parameters = new RebalanceInfoSendParams();
            this.pluginParameters = new RebalanceInfoSendParams();
            this.Parameters.SetParams(this.pluginParameters.GetParams());
            this.ViewModel.Parameters = (RebalanceInfoSendParams)this.Parameters;
        ...
        public RebalanceInfoSendViewerModel ViewModel { get; private set; }
        ...
        public void ShowSettings()
        {
            ...
            ReblanceInfoSendSettingsViewModel settingsViewModel = new ReblanceInfoSendSettingsViewModel(this.ViewModel, this.GenericWindow);
