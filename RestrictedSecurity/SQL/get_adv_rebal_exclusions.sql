...
select se_restricted_security.account_id ,
se_restricted_security.security_id,
0 as position_type_code,
se_restricted_security.encumber_type,
se_restricted_security.isEncumbered,
se_restricted_security.exception_date,
se_restricted_security.tax_lot_id,
se_restricted_security.restriction_description,
se_restricted_security.restriction_type,
se_restricted_security.rule_id,
security.symbol,
0 as position_type_code,
account.short_name,
