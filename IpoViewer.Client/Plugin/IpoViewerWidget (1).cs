...
using AccountTreeNavViewer.Framework.Client.SubsPubEvents;
namespace IpoViewerAddIn.Client.DetailReport
{
    ...
    using AccountTreeNavViewer.Framework.WidgetFrame.PluginBase;
    //using Linedata.Shared.Widgets.OrderManager.DataContracts;
    using AccountTreeNavViewer.Client.AddIn.HostView.AppAddIns;
    using AccountTreeNavViewer.Client.AddIn;
    using AccountTreeNavViewer.Client;
